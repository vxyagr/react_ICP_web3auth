...
import { idlFactory } from "./candid/icdragon.did.js";
export { idlFactory } from "./candid/icdragon.did.js";

export const createActor = (canisterId, options = {}) => {
  var args = {};

  args["host"] = process.env.REACT_APP_CANISTER_ADDRESS; //canister deploy location on ICP - ask canister developer for this
